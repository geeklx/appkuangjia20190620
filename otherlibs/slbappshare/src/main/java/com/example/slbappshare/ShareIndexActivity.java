...
//        JShareInterface.init(this);
    ...
    public void BTN1(View view) {
        //分享弹窗bufen
        Intent intent = new Intent("hs.act.slbapp2.ShareBottomActivity");
        intent.putExtra("type", Platform.ACTION_SHARE);//授权
        startActivity(intent);
    }

    public void BTN2(View view) {
        Intent intent = new Intent("hs.act.slbapp2.ShareIndex1Activity");
        intent.putExtra("type", Platform.ACTION_AUTHORIZING);//授权
        startActivity(intent);
    }

    public void BTN3(View view) {
        Intent intent = new Intent("hs.act.slbapp2.ShareIndex2Activity");
